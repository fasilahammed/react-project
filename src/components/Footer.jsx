  ...
  return (
    <footer className="bg-white text-gray-800 border-t border-gray-200">
      ...
      <div className="bg-orange-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          {/* RESPONSIVE GRID FOR FEATURES:
            - Default (mobile): 1 column (stacks vertically)
            - sm (small screens, >640px): 2 columns
            - lg (large screens, >1024px): 4 columns 
          */}
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            
            {/* RESPONSIVE FEATURE ITEM:
              - Default (mobile): `flex-col` (icon above text), `text-center`
              - sm (small screens): `flex-row` (icon beside text), `text-left`
            */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        {/*
          RESPONSIVE GRID FOR MAIN FOOTER:
          - Default (mobile): 1 column (all sections stack)
          - md (medium screens, >768px): 2 columns
          - lg (large screens, >1024px): 4 columns
        */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="/products" className="text-gray-600 hover:text-orange-500 transition-colors">All Products</a></li>
              <li><a href="/new-arrivals" className="text-gray-600 hover:text-orange-500 transition-colors">New Arrivals</a></li>
              <li><a href="/deals" className="text-gray-600 hover:text-orange-500 transition-colors">Today's Deals</a></li>
              <li><a href="/best-sellers" className="text-gray-600 hover:text-orange-500 transition-colors">Best Sellers</a></li>
              <li><a href="/accessories" className="text-gray-600 hover:text-orange-500 transition-colors">Accessories</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="/shipping" className="text-gray-600 hover:text-orange-500 transition-colors">Shipping Policy</a></li>
              <li><a href="/returns" className="text-gray-600 hover:text-orange-500 transition-colors">Returns & Refunds</a></li>
          ...
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-2">
              <input 
                ...
                className="px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 flex-1 w-full"
              />
      ...
      <div className="bg-gray-50 border-t border-gray-200 py-6">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {/* Responsive Copyright: Stacks on mobile, side-by-side on medium screens */}
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-6">
              ...
              <a href="/sitemap" className="text-gray-500 hover:text-orange-500 text-sm">Sitemap</a>
            </div>
          </div>
        </div>
      </div>
