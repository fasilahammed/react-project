  ...
  useEffect(() => {
    const fetchOrders = async () => {
      try {
        ...
        // For demo purposes, we'll use cart items as orders
        const allOrders = users.flatMap(user => 
          user.cart ? user.cart.map(item => ({
            ...item,
            id: `${user.id}-${item.id}`, // Create a unique ID
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex space-x-2">
          <select
            ...
            className="px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 dark:bg-gray-800 dark:border-gray-700 dark:text-white"
          >
